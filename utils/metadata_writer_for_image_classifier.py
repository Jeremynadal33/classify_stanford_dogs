...
def main(_):
  ...
  print('Base export_model_path : ', FLAGS.export_directory, os.path.exists(FLAGS.export_directory))
  print('Base export_model_path : ', FLAGS.export_directory[1:], os.path.exists(FLAGS.export_directory[1:]))
  export_model_path = os.path.join(FLAGS.export_directory[1:], model_basename)
  ...
  export_json_file = os.path.join(FLAGS.export_directory[1:],
